<template>
    <div>
        ...
        <div v-if="!booked" class="form-container text-light" align="center">
            <h1 class="text-center text-light"><i class="far fa-calendar-check" :style="{ fontSize: '100px' }"></i> Proceed with your appointment</h1><br/>
            <ValidationObserver v-slot="{ invalid }">
                <form class="form" @submit.prevent="handleSubmit">
                    ...
                    <div class="col-7" align="center" :style="{ marginRight: '20px' }">
                        <button class="btn btn-primary btn-block" :disabled="invalid">Book an appointment</button>
                    </div>
                </form>
            </ValidationObserver>
        </div>
...
export default {
    ...
    methods: {
        handleSubmit: function() {
            ...
            this.$http.post(`http://localhost:4000/users/booking/${this.userId}/${this.coachId}`, data).then(response => {
